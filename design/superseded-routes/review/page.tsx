...
import { Card, Chip, Empty, H1 } from "@/components/ui";
...
export default function ReviewPage() {
  ...
  if (down) {
    return (
      <>
        <H1 sub={SUB}>Tidy up</H1>
        <Empty title="The analyser is not running, so there is nothing to tidy yet.">
  ...
  if (failed) {
    return (
      <>
        <H1 sub={SUB}>Tidy up</H1>
        <Empty title="This list could not be loaded.">
