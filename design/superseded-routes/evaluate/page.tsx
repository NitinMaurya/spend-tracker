...
import { prettyCategory } from "@/components/charts";
import { Card, Chip, H1, H2 } from "@/components/ui";
...
export default function EvaluatePage() {
  ...
  return (
    <div className="space-y-9">
      <H1 sub="Drop a card's Key Facts Statement and find out what it would actually have paid you — priced against your own statements, not a marketing example.">
        ...
        <label
          ...
          className={`block cursor-pointer rounded-card border-2 border-dashed p-10 text-center shadow-card transition-all sm:p-14 ${
            dragging
              ...
              : "border-line bg-card hover:border-accent/60 hover:bg-card2"
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="rise" style={{ animationDelay: "80ms" }}>
        <div className="rounded-card border border-line bg-card p-6 shadow-lift sm:p-8">
      ...
      <section className="rise" style={{ animationDelay: "200ms" }}>
        <H2>Where the reward would come from</H2>
...
function Figure({
  ...
  return (
    <div className="rounded-card border border-line bg-card2 px-4 py-3.5">
...
function Breakdown({ lines }: { lines: EvalLine[] }) {
  ...
  return (
    <div className="overflow-hidden rounded-card border border-line bg-card shadow-card">
      ...
      <div className="flex items-baseline justify-between gap-4 border-t border-line bg-card2 px-4 py-3 text-xs text-ink3 sm:px-5">
...
function Fine({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <details className="group rounded-card border border-line bg-card px-5 py-4 shadow-card">
